    ...
    ?>
        <div class="row">
            <div class="col-12 col-lg-4 mb-3">
                ...
                <div class="mb-3">
                    <a class="btn btn-success" href="index.php?menu=locacao&idCliente=<?= $idCliente ?>&menuOpLocacao=addLocacao">Nova locação</a>
                </div>
            ...
            WHERE cli.idCliente = {$idCliente} order by statusLocacao asc,dataLocacao desc, idLocacao desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-outline-secondary" href="index.php?menu=locacao&idCliente=<?= $dados["idCliente"] ?>&idLocacao=<?= $dados["idLocacao"] ?>"><i class="ph-duotone ph-link"></i></a></td>
                            </tr>
                        <?php
                        }
                        ?>
                    ...
                    <div class="mb-3">
                        ...
                        <form action="" method="get">
                            ...
                            where statusFilme = 0";
                                    ...
                                    while ($dados = mysqli_fetch_assoc($rs)) {
                                    ?>
                                        <option value="<?= $dados["idFilme"] ?>"><?= $dados["idFilme"] ?> - <?= $dados["tituloFilme"] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                                <input class="form-control" type="date" name="dataDeEntrega" id="dataDeEntrega" value="<?= $dataDeEntrega ?>">
                                <button class="btn btn-success" type="submit"><i class="ph-duotone ph-video"></i> Add Vídeo</button>
                            </div>
                        </form>
                    </div>
                        ...
                        as statusItemLocado    
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-outline-success" href="index.php?menu=locacao&idCliente=<?= $idCliente ?>&idLocacao=<?= $idLocacao ?>&menuOpLocacao=baixaVideo&idFilme=<?= $dados["idFilme"] ?>"><i class="ph-duotone ph-check-fat"></i></a></td>
                                    <td><a class="btn btn-outline-danger" href="index.php?menu=locacao&idCliente=<?= $idCliente ?>&idLocacao=<?= $idLocacao ?>&menuOpLocacao=removeVideo&idFilme=<?= $dados["idFilme"] ?>"><i class="ph-duotone ph-trash"></i></a></td>
